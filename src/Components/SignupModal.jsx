  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8">
          {/* Header */}
          <h2 className="text-3xl font-bold text-[#0071BD] mb-2">Sign Up</h2>
          <p className="text-gray-600 mb-4">Join Nova Tuitions today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#D4A024] to-[#F4C430] text-white font-bold py-3 rounded-lg hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200"
            >
              Sign Up
            </button>
