    ...
    return (
        <div className="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col h-full">
            ...
            <div className="p-8 flex-1 flex flex-col items-center text-center">
                <div className="mb-4 w-full">
                    <div className="flex flex-col gap-3 mb-4 items-center">
                        <div className="flex flex-col gap-2 items-center">
                            <h3 className="text-2xl font-extrabold text-gray-900 group-hover:text-blue-900 transition-colors duration-300 font-serif" style={{fontFamily: 'Georgia, serif'}}>
                                {tutor.fullName || tutor.name}
                            </h3>
                            {/* Category removed as per user request */}
                ...
                {/* Specialty removed as per user request */}
        ...
        <div className="min-h-screen bg-[#F8FAFC]">
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-800 py-24">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight font-serif" style={{fontFamily: 'Georgia, serif'}}>
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                {loading ? (
                    ...
                    <div className="text-center py-24 bg-white rounded-3xl shadow-sm border border-gray-100">
                        ...
                        <h3 className="text-2xl font-bold text-gray-800 mb-2 font-serif" style={{fontFamily: 'Georgia, serif'}}>No Tutors Found</h3>
                    ...
                    <div className="space-y-12">
                        ...
                        {searchTerm && (
                            <div className="mb-10 text-center">
                                <h2 className="text-2xl font-bold text-gray-800 font-serif" style={{fontFamily: 'Georgia, serif'}}>
            ...
            <section className="py-24 bg-white px-4">
                <div className="max-w-5xl mx-auto rounded-[3rem] bg-gradient-to-r from-blue-600 to-indigo-700 p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-3xl md:text-5xl font-extrabold mb-6 font-serif" style={{fontFamily: 'Georgia, serif'}}>Start Your Journey To Excellence</h2>
