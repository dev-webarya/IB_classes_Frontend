      ...
      <div className="max-w-sm w-full relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600">Welcome back to IB Online Classes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#D4A024] to-[#F4C430] text-white font-bold py-2.5 rounded-lg hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200 text-sm disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
            >
            ...
            <p className="text-center text-gray-600 text-sm">
              ...
              <Link to="/signup" className="text-[#0071BD] hover:underline font-semibold">
                Sign Up
              </Link>
            </p>
