    ...
    const fetchProfile = async () => {
      try {
        setFormData({
          ...
          email: adminData?.email || 'admin@ibclassesonline.com',
      ...
      <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8 pb-8 border-b-2" style={{ borderColor: '#f0f0f0' }}>
          <div className="flex items-center gap-6">
            ...
            <div>
              <h3 className="text-2xl font-bold text-blue-900">{adminData?.name || 'Admin'}</h3>
              <p className="text-gray-600">{formData.position}</p>
              <p className="text-sm text-gray-500">ID: {adminData?.adminId || 'ADM-001'}</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-lg font-semibold">{adminData?.adminId || 'ADM-001'}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600 font-semibold mb-1">Role</p>
            <p className="text-lg font-semibold">{adminData?.role || 'Administrator'}</p>
          </div>
          <div>
